...
class VideoMenu:
    def __init__(self):
        ...
        self.all_uis = [self.fov_base, self.fov_lever]
    ...
    def draw(self, screen):
        ...
        for ob in self.all_uis:
            ob.draw(screen)
        ui.show_text(screen, f"FOV: {self.fov_value}", tool.Colors.WHITE, self.fov_base.rect.centerx, self.fov_base.rect.centery, center=True, size=30)
